 ...
 */
{
	...
	DOM.textAnimations = Array.from(document.querySelectorAll('.content-wrap'));
	// DOM.likeList = Array.from(document.querySelectorAll('.content-wrap'));
